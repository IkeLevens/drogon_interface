...
short leftRecord;
short rightRecord;
void leftCallback (const baxter_msgs::EndpointState& msg);
...
int main (int argc, char** argv)
{
	...
	ros::Subscriber sub1 = n.subscribe("/sdk/robot/limb/left/endpoint/state", 1, leftCallback);
	ros::Subscriber sub2 = n.subscribe("/sdk/robot/limb/right/endpoint/state", 1, rightCallback);
	ftime(&timmy);
